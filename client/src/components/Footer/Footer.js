...
const Footer = () => (
    <footer class="flex-rw">
        ...
        <ul class="footer-list-top">
            <li>
                <h4 class="footer-list-header">About WIMB</h4></li>
        ...
        <ul class="footer-list-top">
            <li>
                <h4 class="footer-list-header">IDK</h4></li>


            <li><a href='/Angels/cat/id/70' class="generic-anchor footer-list-anchor">Comething</a></li>
            <li><a href='/Home-Decor/cat/id/64' class="generic-anchor footer-list-anchor">Something Else</a></li>
            <li><a href='/Mugs/cat/id/32' class="generic-anchor footer-list-anchor">Other</a></li>
            <li><a href='/Pet-Lover/cat/id/108' class="generic-anchor footer-list-anchor">Another</a></li>
            <li><a href='/Ladies-Accessories/cat/id/117' class="generic-anchor footer-list-anchor" target="_blank">again other</a></li>
        </ul>
        <ul class="footer-list-top">
            <li id='help'>
            ...
            <li><a href='#' class="generic-anchor footer-list-anchor" itemprop="significantLink">Phone</a></li>
            <li id='find-a-store'><a href='#' class="generic-anchor footer-list-anchor" itemprop="significantLink">Name</a></li>
            <li id='user-registration'><a href='#' class="generic-anchor footer-list-anchor" itemprop="significantLink">Why?</a></li>
            <li id='order-tracking'><a href='#' itemprop="significantLink" class="generic-anchor footer-list-anchor"></a></li>
        </ul>
        ...
        <section class="footer-bottom-section flex-rw">
            <div class="footer-bottom-wrapper">
                ...
                </i> 2018 WIMB Inc. <address class="footer-address" role="company address">Atlanta, GA</address><span class="footer-bottom-rights"> - All Rights Reserved - </span>
            </div>
            <div class="footer-bottom-wrapper">
